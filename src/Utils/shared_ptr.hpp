 ...
 *
 *  This file includes "boost/shared_ptr.hpp" if UTILS_USE_BOOST_SHARED_PTR is defined,
 * or <memory> (or <tr1/memory>) when C++11 (or experimental C++0x) is available,
 * and imports the symbol "shared_ptr" inside the current namespace (ie. Utils::shared_ptr).
...
//
#ifdef UTILS_USE_BOOST_SHARED_PTR
